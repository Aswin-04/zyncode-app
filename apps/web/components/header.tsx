        ...
        <div className="flex gap-16">
          ...
          {roomId && (
            <div className="flex justify-center items-center gap-4">
              <div className="flex justify-center items-center">
                <span className="text-black bg-white/80 border-1 px-4 py-2 rounded-sm">
                  Room Id
                </span>{" "}
                <span className="text-lg font-medium text-blue-500 border-1 px-8 py-2 rounded-sm bg-gray-950">
                  {roomId}
                </span>
              </div>
              <DialogLeaveButton
          ...
          {user && (
            <div className="flex justify-center items-center  gap-2">
              <div className="flex justify-center items-center text-xl text-black w-10 h-10 rounded-full border-1 bg-white/80">
                {user?.name[0]}
              </div>
